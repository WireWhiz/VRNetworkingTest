...
#pragma warning restore 649
        ...
        public ArchetypeChunkComponentType<CameraRigChild> ghostCameraRigChildType;
    ...
    protected override void OnCreate()
    {
        ...
        m_interpolatedQuery = GetEntityQuery(new EntityQueryDesc
        {
            All = new []{
                ...
                ComponentType.ReadWrite<CameraRigChild>(),
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostCameraRigChildType = GetArchetypeChunkComponentType<CameraRigChild>(),
